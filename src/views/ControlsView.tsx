...
export default function ControlsView() {
  const { project, validationReport } = useProjectStore();
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex items-center gap-3 px-4 py-2 border-b border-[#30363d] bg-[#161b22] shrink-0">
        ...
        <div className="ml-auto text-xs text-[#484f58]">
          Grid editing coming soon — use the Boards tab to add boards and pin assignments.
        </div>
      </div>
      ...
      <div className="flex-1 overflow-auto">
                ...
                return (
                  ...
                  >
                    <td colSpan={columns.length} className="px-3 py-2">
                      <span className="text-xs mr-2 text-[#484f58]">
                        {row.getIsExpanded() ? "▼" : "▶"}
                      </span>
        ...
        {project.controls.length === 0 && (
          <div className="flex flex-col items-center justify-center py-20 text-[#484f58]">
            ...
            <p className="text-sm">Add controls via the project file or the editor (coming soon).</p>
          </div>
        )}
      </div>
